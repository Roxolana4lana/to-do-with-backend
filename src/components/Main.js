...
console.log(this.state.tasks)
  ...
  render() {
    //  let lili = this.state.newtasks!==[]?(this.state.newtasks.map((tit, index)=>{
    //      return(<li key={index}>{tit.task}</li>)
    //  })):null
     // value = { this.state.tasks[idx].name }
    ...
    return (
        <div className='Main'>
            <div className='mainButtons'>
                <h1>To do list</h1>
              <div className='but' >
            <button className='myButton' onClick={this.Add}><i className="fas fa-plus " style={{ fontSize: '2rem' }}></i></button>
            ...
            <button className='myButton' onClick={this.handleClear}><i className="fas fa-trash-alt " style={{ fontSize: '2rem' }}></i></button>
                <button className='myButton' onClick={this.handleSubmit}><i className="fas fa-save" style={{ fontSize: '2rem' }}></i></button>
                    <Link to='/list'><button className='myButton' ><i className="fas fa-list-ol" style={{ fontSize: '2rem' }}></i> </button></Link>
                </div>
                {
